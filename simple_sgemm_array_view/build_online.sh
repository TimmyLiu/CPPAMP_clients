...
/opt/hcc/bin/hcc `/opt/hcc/bin/clamp-config --ldflags` -o AMP_SGEMM_EXE AMP_SGEMM_MAIN.o error_checking.o dummy_sgemm.o init_random.o -L/opt/hsa/lib -lhsa-runtime64 -lelf -lm -ldl